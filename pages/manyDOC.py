...
st.title("manyDOC :bookmark_tabs:")
st.subheader("Upload and chat with your documents!")


uploaded_file_1, uploaded_file_2 = None, None

uploaded_file_1 = st.file_uploader('Upload File 01', type="pdf")
uploaded_file_2 = st.file_uploader('Upload File 02', type="pdf")

filename_1 = "uploaded_pdfs/document_1.pdf"
filename_2 = "uploaded_pdfs/document_2.pdf"

if uploaded_file_1 is not None and uploaded_file_2 is not None:
    # To read file as bytes:
    bytes_data_1 = uploaded_file_1.getvalue()

    with open(filename_1, 'wb') as f: 
        f.write(bytes_data_1)

    # To read file as bytes:
    bytes_data_2 = uploaded_file_2.getvalue()

    with open(filename_2, 'wb') as f: 
        f.write(bytes_data_2)

    # if uploaded_file is not None:

    loaders = [#PyPDFLoader("/home/sohug/DATAPRAME/DATA/pdf/attention.pdf"),
            PyPDFLoader("uploaded_pdfs/document_1.pdf"),
            PyPDFLoader("uploaded_pdfs/document_2.pdf"),
